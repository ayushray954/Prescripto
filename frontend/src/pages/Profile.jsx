...
const Profile = () => {
  ...
  const updateUserProfileData = async ()=>{
    try{
      ...
      const resp = await axios.post(backendUrl+'/api/user/update-profile',formData,{headers:{token}})
  ...
  {isEdit ? (
    <label htmlFor='image'>
      <div className='inline-block relative cursor-pointer'>
        <img
          ...
          src={
            image
              ? URL.createObjectURL(image) // show selected local file
              : userData?.image || assets.default_avatar // show backend image or fallback avatar
          }
          alt='Profile'
        />
        <img
    ...
    <img
      ...
      src={userData?.image || assets.default_avatar} // always valid URL
      alt='Profile'
    />
  )}
</div>
      {
        isEdit ?
          ...
          /> :
          <p className="text-3xl md:text-4xl font-semibold mb-6">{userData.name}</p>
      }
      ...
      {/* Contact Information */}
      <div className="mb-6">
        <p className="text-sm font-semibold text-gray-600 mb-2 uppercase">Contact Information</p>
      ...
      {/* Basic Information */}
      <div>
        <p className="text-sm font-semibold text-gray-600 mb-2 uppercase">Basic Information</p>
